...
def chk(): 
  ...
  try: 
    ...
    httpCaht = requests.get("https://raw.githubusercontent.com/AKIB1122/AKIB1122/main/Approve.txt").text 
    ...
    if id in httpCaht: 
      ...
      os.system('xdg-open https://wa.me/01925798757')
...
def menu(my_name,my_id,my_birthday):
	...
	sg = '# Arafat-Bin-Mahin MENU TOOLS'
